...
class ClubCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addColumn([
            'name' => 'name',
            'label' => trans('backpack::club.name'),
            'type' => 'text'
        ]);

        $this->crud->addColumn([
            'name' => 'address',
            'label' => trans('backpack::club.address'),
            'type' => 'text'
        ]);

        $this->crud->addColumn([
            'name' => 'city',
            'label' => trans('backpack::club.city'),
            'type' => 'text'
        ]);

        $this->crud->addColumn([
            'name' => 'phone',
            'label' => trans('backpack::club.phone'),
            'type' => 'text'
        ]);

        $this->crud->addColumn([
            'name' => 'active',
            'label' => trans('backpack::club.active'),
            'type' => 'text',
            'options' => [
                1 => "Si",
                0 => "No"
        ...
        $this->crud->addField([
            'name' => 'name',
            'label' => trans('backpack::categories.name') ,
            'type' => 'text',
        ]);
